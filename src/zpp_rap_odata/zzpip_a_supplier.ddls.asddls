/********** GENERATED on 05/20/2021 at 08:38:37 by CB0000000547**************/
 ...
 define root abstract entity ZZPIP_A_SUPPLIER { 
...
//On-condition is not relevant for runtime 
 _SupplierCompany : association [0..*] to ZZPIP_A_SUPPLIERCOMPANY on 1 = 1; 
 @OData.property.name: 'to_SupplierPurchasingOrg' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _SupplierPurchasingOrg : association [0..*] to ZZPIP_A_SUPPLIERPURCHASINGORG on 1 = 1; 
 @OData.property.name: 'to_SupplierText' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _SupplierText : association [0..*] to ZZPIP_A_SUPPLIERTEXT on 1 = 1; 
 } 
