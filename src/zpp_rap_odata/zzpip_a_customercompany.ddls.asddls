/********** GENERATED on 05/20/2021 at 08:38:33 by CB0000000547**************/
 @OData.entitySet.name: 'A_CustomerCompany' 
 @OData.entityType.name: 'A_CustomerCompanyType' 
 define root abstract entity ZZPIP_A_CUSTOMERCOMPANY { 
...
//On-condition is not relevant for runtime 
 _CompanyText : association [0..*] to ZZPIP_A_CUSTOMERCOMPANYTEXT on 1 = 1; 
 @OData.property.name: 'to_CustomerDunning' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _CustomerDunning : association [0..*] to ZZPIP_A_CUSTOMERDUNNING on 1 = 1; 
 @OData.property.name: 'to_WithHoldingTax' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _WithHoldingTax : association [0..*] to ZZPIP_A_CUSTOMERWITHHOLDINGTAX on 1 = 1; 
 } 
