/********** GENERATED on 05/20/2021 at 08:38:37 by CB0000000547**************/
 @OData.entitySet.name: 'A_SupplierCompany' 
 @OData.entityType.name: 'A_SupplierCompanyType' 
 define root abstract entity ZZPIP_A_SUPPLIERCOMPANY { 
...
//On-condition is not relevant for runtime 
 _CompanyText1 : association [0..*] to ZZPIP_A_SUPPLIERCOMPANYTEXT on 1 = 1; 
 @OData.property.name: 'to_Supplier' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _Supplier1 : association [1] to ZZPIP_A_SUPPLIER on 1 = 1; 
 @OData.property.name: 'to_SupplierDunning' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _SupplierDunning : association [0..*] to ZZPIP_A_SUPPLIERDUNNING on 1 = 1; 
 @OData.property.name: 'to_SupplierWithHoldingTax' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _SupplierWithHoldingTax : association [0..*] to ZZPIP_A_SUPPLIERWITHHOLDINGTAX on 1 = 1; 
 } 
