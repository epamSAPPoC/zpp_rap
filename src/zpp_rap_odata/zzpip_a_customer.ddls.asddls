/********** GENERATED on 05/20/2021 at 08:38:32 by CB0000000547**************/
 ...
 define root abstract entity ZZPIP_A_CUSTOMER { 
...
//On-condition is not relevant for runtime 
 _CustomerCompany : association [0..*] to ZZPIP_A_CUSTOMERCOMPANY on 1 = 1; 
 @OData.property.name: 'to_CustomerSalesArea' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _CustomerSalesArea : association [0..*] to ZZPIP_A_CUSTOMERSALESAREA on 1 = 1; 
 @OData.property.name: 'to_CustomerTaxGrouping' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _CustomerTaxGrouping : association [0..*] to ZZPIP_A_CUSTOMERTAXGROUPING on 1 = 1; 
 @OData.property.name: 'to_CustomerText' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _CustomerText : association [0..*] to ZZPIP_A_CUSTOMERTEXT on 1 = 1; 
 } 
