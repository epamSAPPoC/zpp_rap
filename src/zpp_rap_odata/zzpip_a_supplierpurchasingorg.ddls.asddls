/********** GENERATED on 05/20/2021 at 08:38:39 by CB0000000547**************/
 @OData.entitySet.name: 'A_SupplierPurchasingOrg' 
 @OData.entityType.name: 'A_SupplierPurchasingOrgType' 
 define root abstract entity ZZPIP_A_SUPPLIERPURCHASINGORG { 
...
//On-condition is not relevant for runtime 
 _PartnerFunction1 : association [0..*] to ZZPIP_A_SUPPLIERPARTNERFUNC on 1 = 1; 
 @OData.property.name: 'to_PurchasingOrgText' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _PurchasingOrgText : association [0..*] to ZZPIP_A_SUPPLIERPURCHASINGORGT on 1 = 1; 
 } 
