/********** GENERATED on 05/20/2021 at 08:38:34 by CB0000000547**************/
 ...
 define root abstract entity ZZPIP_A_CUSTOMERSALESAREA { 
...
//On-condition is not relevant for runtime 
 _PartnerFunction : association [0..*] to ZZPIP_A_CUSTSALESPARTNERFUNC on 1 = 1; 
 @OData.property.name: 'to_SalesAreaTax' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _SalesAreaTax : association [0..*] to ZZPIP_A_CUSTOMERSALESAREATAX on 1 = 1; 
 @OData.property.name: 'to_SalesAreaText' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _SalesAreaText : association [0..*] to ZZPIP_A_CUSTOMERSALESAREATEXT on 1 = 1; 
 } 
