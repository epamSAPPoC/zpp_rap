/********** GENERATED on 05/20/2021 at 08:38:27 by CB0000000547**************/
 @OData.entitySet.name: 'A_BPContactToAddress' 
 @OData.entityType.name: 'A_BPContactToAddressType' 
 define root abstract entity ZZPIP_A_BPCONTACTTOADDRESS { 
...
//On-condition is not relevant for runtime 
 _EmailAddress : association [0..*] to ZZPIP_A_ADDRESSEMAILADDRESS on 1 = 1; 
 @OData.property.name: 'to_FaxNumber' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _FaxNumber : association [0..*] to ZZPIP_A_ADDRESSFAXNUMBER on 1 = 1; 
 @OData.property.name: 'to_MobilePhoneNumber' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _MobilePhoneNumber : association [0..*] to ZZPIP_A_ADDRESSPHONENUMBER on 1 = 1; 
 @OData.property.name: 'to_PhoneNumber' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _PhoneNumber : association [0..*] to ZZPIP_A_ADDRESSPHONENUMBER on 1 = 1; 
 @OData.property.name: 'to_URLAddress' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _URLAddress : association [0..*] to ZZPIP_A_ADDRESSHOMEPAGEURL on 1 = 1; 
 } 
