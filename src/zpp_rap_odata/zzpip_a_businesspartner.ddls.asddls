/********** GENERATED on 05/20/2021 at 08:38:29 by CB0000000547**************/
 ...
 define root abstract entity ZZPIP_A_BUSINESSPARTNER { 
...
//On-condition is not relevant for runtime 
 _BuPaIdentification : association [0..*] to ZZPIP_A_BUPAIDENTIFICATION on 1 = 1; 
 @OData.property.name: 'to_BuPaIndustry' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _BuPaIndustry : association [0..*] to ZZPIP_A_BUPAINDUSTRY on 1 = 1; 
 @OData.property.name: 'to_BusinessPartnerAddress' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _BusinessPartnerAddress : association [0..*] to ZZPIP_A_BUSINESSPARTNERADDRESS on 1 = 1; 
 @OData.property.name: 'to_BusinessPartnerBank' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _BusinessPartnerBank : association [0..*] to ZZPIP_A_BUSINESSPARTNERBANK on 1 = 1; 
 @OData.property.name: 'to_BusinessPartnerContact' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _BusinessPartnerContact : association [0..*] to ZZPIP_A_BUSINESSPARTNERCONTACT on 1 = 1; 
 @OData.property.name: 'to_BusinessPartnerRole' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _BusinessPartnerRole : association [0..*] to ZZPIP_A_BUSINESSPARTNERROLE on 1 = 1; 
 @OData.property.name: 'to_BusinessPartnerTax' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _BusinessPartnerTax : association [0..*] to ZZPIP_A_BUSINESSPARTNERTAXNUMB on 1 = 1; 
 @OData.property.name: 'to_Customer' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _Customer : association [1] to ZZPIP_A_CUSTOMER on 1 = 1; 
 @OData.property.name: 'to_Supplier' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _Supplier : association [1] to ZZPIP_A_SUPPLIER on 1 = 1; 
 } 
